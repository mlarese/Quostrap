<template>
    ...
    <div class="panel-footer"><p class="text-muted"><em class="fa fa-upload fa-fw"></em><span>{{monthDate}}</span><span class="text-dark">{{value}}</span></p>
    </div></div>
</template>
...
<script>
  export default {
    props: {
      ...
      monthDate: {default: 'Last Month'},
      value: {default: '1200 GB'}
    }
  }
</script>
